...
var option13 = {
    ...
    colors: ['var(--primary)','#00ca00','#ffd400' ],
    series: [44, 55, 67],
    stroke: {
        lineCap: 'round'
    },
...
var option15 = {
    ...
    colors: ['#00ca00' ,'var(--primary)','#e64141'],
    series: [{
        name: 'Income',
        type: 'column',
...
var option18 = {
    ...
    series: [44, 55, 41],
    colors: ['#00ca00','#e64141' ,'var(--primary)'],
...
if(jQuery('#chartdiv').length){
    ...
    if(jQuery('#apex-column').length){
        var options = {
            ...
            colors: ['var(--primary)', '#00ca00', '#ffc107'],
            series: [{
                name: 'Net Profit',
    ...
    if(jQuery('#apex-mixed-chart').length){
      ...
      colors: ['#ffc107', '#00ca00', 'var(--primary)'],
      series: [{
        name: 'Facebook',
        type: 'column',
    ...
    if(jQuery('#apex-bubble-chart').length){
        ...
        var options = {
            ...
            colors:['var(--primary)', '#00ca00', '#e64141'],
            title: {
    ...
    if(jQuery('#apex-radialbar-chart').length){
        var options = {
            ...
            colors: ['var(--primary)', '#00ca00', '#e64141', '#ffd400'],
    ...
    if(jQuery('#apex-pie-chart').length){
        var options = {
            ...
            colors: ['var(--primary)', '#00ca00', '#e64141', '#ffd400', '#00d0ff'],
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
    ...
    // Am Charts 
     ...
     if(jQuery('#am-simple-chart').length){
        ...
        chart.colors.list = [am4core.color("var(--primary)"),];
     ...
     if(jQuery('#am-columnlinr-chart').length){
        ...
        lineSeries.stroke = am4core.color("var(--primary)");
     ...
     if(jQuery('#am-polar-chart').length){
        ...
        range.axisFill.fill = am4core.color("var(--primary)");
     ...
     if(jQuery('#am-polarscatter-chart').length){
        ...
        var chart = am4core.create("am-polarscatter-chart", am4charts.RadarChart);
         chart.colors.list = [am4core.color("var(--primary)"),am4core.color("#ffd400"),am4core.color("#00ca00")];
     ...
     if(jQuery('#am-3dpie-chart').length){
        ...
        series.colors.list = [am4core.color("var(--primary)"),am4core.color("#00ca00"),am4core.color("#e64141"),
     ...
     if(jQuery('#am-layeredcolumn-chart').length){
        ...
        chart.colors.list = [am4core.color("#00ca00"),am4core.color("var(--primary)")];
...
$(document).ready(function() {
    ...
    if(jQuery('#home-perfomer-chart').length){
        ...
        colors: ['var(--primary)','#e64141','#ffd400','#00d0ff'],
        plotOptions: {
          radialBar: {
            dataLabels: {
              name: {
...
if(jQuery('#menu-chart-01').length){
  ...
  if(jQuery('#menu-chart-04').length){
    ...
    range.value = 90.4;
    range.grid.stroke = am4core.color("var(--primary)");
